...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            # args listed as is, instead of in brackets, in case it returns none
...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('account'))  # redirecting here avoids post -> get redirect pattern
